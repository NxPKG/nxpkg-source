...
describe('application', () => {
  const schematicRunner = new SchematicTestRunner('@nxpkg/schematics', path.join(__dirname, '../collection.json'));
  ...
  it('should update package.json', () => {
    ...
    expect(packageJson.devDependencies['@nxpkg/schematics']).toBeDefined();
    expect(packageJson.dependencies['@nxpkg/nxpkg']).toBeDefined();
