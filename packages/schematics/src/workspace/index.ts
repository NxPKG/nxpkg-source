...
import { toFileName } from '@nxpkg/schematics';
...
function updatePackageJson() {
  return (host: Tree) => {
    ...
    if (!packageJson.dependencies['@nxpkg/nxpkg']) {
      packageJson.dependencies['@nxpkg/nxpkg'] = nxVersion;
    }
    ...
    if (!packageJson.devDependencies['@nxpkg/schematics']) {
      packageJson.devDependencies['@nxpkg/schematics'] = schematicsVersion;
    }
...
function updateAngularCLIJson(options: Schema) {
  return (host: Tree) => {
    ...
    angularCliJson.defaults.schematics['collection'] = '@nxpkg/schematics';
