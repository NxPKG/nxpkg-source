...
describe('application', () => {
  ...
  describe('generate', () => {
    it('should work', () => {
      ...
      runSchematic('@nxpkg/bazel:app --name=myApp');
    ...
    it('should work with multiple applications', () => {
      runSchematic('@nxpkg/bazel:application --name=proj');
      runSchematic('@nxpkg/bazel:app --name=first');
      runSchematic('@nxpkg/bazel:app --name=second');
